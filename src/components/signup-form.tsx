...
export function SignupForm({
  ...
  const { validateSignup } = useAuthenticationFlow();
    ...
    <form className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <div className="grid gap-6">
        <div className="grid gap-2">
          ...
          <SuccessIndicator show={isFullNameValid && fullName !== ""} fieldName="Name" />
        </div>
        <div className="grid gap-2">
        ...
        <Button
          ...
          disabled={
            ...
            !fullNameRules.every((rule) => rule.validate(fullName))
          }
        >
          {isSubmitting ? (
            <>
